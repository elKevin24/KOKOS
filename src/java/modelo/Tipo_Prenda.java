...
public class Tipo_Prenda {
    ...
    public static LinkedList<BeanPrenda> consultaTipo_Prenda() throws SQLException {
        LinkedList<BeanPrenda> usuarios = new LinkedList<>();
        String sql = "SELECT id_prenda, prenda FROM kokos.prenda";
        ...
        try {
            ...
            try (Connection con = c.getConexion()) {
                ...
                try (ResultSet rs = st.executeQuery(sql)) {
                    while (rs.next()) {
                        BeanPrenda user = new BeanPrenda();
                        user.setId(rs.getString("id_prenda"));
                        user.setName(rs.getString("prenda"));
